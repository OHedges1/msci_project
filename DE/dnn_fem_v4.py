...
def get_grad(alphas, ts):
    ...
    for p in range(1, n):
        ...
        for i in range(p+1, n):
            E2 += (2/3) * alphas[p] * (ts[i]**(-1/3) - ts[i+1]**(-1/3))
...
plt.plot(points, points **(2/3) - points, label='solution')
